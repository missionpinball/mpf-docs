...
exclude_patterns = ['_build', '_not_updated_yet']
...
html_static_path = ['_static', 'example_configs']
...
latex_documents = [
    (master_doc, 'MissionPinballFramework.tex', 'Mission Pinball Framework Documentation',
...
man_pages = [
    (master_doc, 'missionpinballframework', 'Mission Pinball Framework Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MissionPinballFramework', 'Mission Pinball Framework Documentation',
     author, 'MissionPinballFramework', 'One line description of project.',
     'Miscellaneous'),
]
