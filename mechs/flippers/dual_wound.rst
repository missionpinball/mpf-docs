...
.. literalinclude:: /example_configs/mpf_configs/flippers/config/hold_no_eos.yaml
   :caption: `/config/config.yaml </_static/mpf_configs/flippers/config/hold_no_eos.yaml>`_
   :language: yaml
