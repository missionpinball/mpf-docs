...
The upcoming release of MPF is 0.80, which includes support for the Godot Media Controller (GMC) and drops support for the 0.57 Kivy-based Media Controller (MC). In preparation for full release, we recommend upgrading existing 0.80 projects to the latest dev version, `0.80.0.dev12`.

While there are not many functional changes in MPF between 0.57.4 and 0.80.0, there are some config file migrations necessary and this document will help you through that.
