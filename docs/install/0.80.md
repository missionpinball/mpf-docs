...
The upcoming release of MPF is 0.80, which includes support for the Godot Media Controller (GMC) and drops support for the 0.57 Kivy-based Media Controller (MC). In preparation for full release, we recommend upgrading existing 0.80 projects to the latest dev version, `0.80.0.dev13`.
