...
Start with the [Start Here](../start/index.md) link in the menu.
That will explain an overview of how MPF works and then lead you through the features, the tutorial, and so on.
...
version of MPF unless you need specific features from the "dev" (next) version.
