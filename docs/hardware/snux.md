...
energized and the flippers worked. When that relay was disabled, the
...
skirt switch was hit, so fire the pop bumper now," rather, that switch
...
The key is that you're setting up a "chain" of devices (from
