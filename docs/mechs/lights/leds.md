...
RGBW LEDs are special in most serial LED controllers since the
...
common ground; see
[the voltages and power guide](../../hardware/voltages_and_power/voltages_and_power.md) for details).
