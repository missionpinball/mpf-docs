...
## Upgrading a Legacy MPF-MC project (on 0.57.5) to GMC
...
The latest 2026 development release of MPF (0.80.0.dev14) requires GMC plugin version 0.1.6, which is available on the Asset Library.
