...
.. literalinclude:: /example_configs/plugin_config_player/config/plugin_config_player.yaml
   :caption: `your_machine_folder/config/plugin_config_player.yaml </_static/plugin_config_player/config/plugin_config_player.yaml>`_
   :language: yaml
...
.. literalinclude:: /example_configs/plugin_config_player/shows/show1.yaml
   :caption: `your_machine_folder/shows/show1.yaml </_static/plugin_config_player/shows/show1.yaml>`_
   :language: yaml
