...
.. literalinclude:: /example_configs/shots/config/test_shot_groups.yaml
   :caption: `your_machine_folder/config/test_shot_groups.yaml </_static/shots/config/test_shot_groups.yaml>`_
   :language: yaml

.. literalinclude:: /example_configs/shots/config/test_shots.yaml
   :caption: `your_machine_folder/config/test_shots.yaml </_static/shots/config/test_shots.yaml>`_
   :language: yaml
